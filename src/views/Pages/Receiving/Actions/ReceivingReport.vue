<template>
  ...
  <Modal
    ...
    :maxWidth="'lg'"
    title="Generate Receiving Report"
        ...
        <div>
          <div class="flex justify-end gap-2">
            <a
              ...
              :href="`${VUE_APP_API_URL}ingredient-reports/download-excel-from-to-receiving/${search.from_date}/${search.to_date}`"
              @click="
                console.log(
                  `${VUE_APP_API_URL}ingredient-reports/download-excel-from-to-receiving/${search.from_date}/${search.to_date}`
                )
              "
