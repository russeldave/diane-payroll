  ...
  <div v-if="hasPermission('Navigation_Variance') & hasPermission('Navigation_Reports')">
    <div class="px-4 min-h-screen rounded-lg dark:border-gray-700 bg-white">
      ...
      <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-4">
        <h1 class="text-lg lg:text-2xl font-bold mt-1">Inventory Variance</h1>
      ...
      <div class="flex flex-col lg:flex-row justify-between items-center gap-4 mb-4">
        <div class="flex flex-wrap items-center gap-3">
          <input
            ...
            class="shadow shadow-gray-700 focus-visible:bg-yellow-100 font-bold text-lg py-2 px-4 rounded-lg"
          />
          <select
...
const addPhysicalCount = async (item,index) => {
  try {
    const formData = FormDx({ warehouse_item_id: item.id, physical_count: item.physical_count, date_of_physical_count: date_of_physical_count.value});
