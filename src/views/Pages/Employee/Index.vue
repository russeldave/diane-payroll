  ...
  <div v-if="hasPermission('Navigation_Employees')">
    <div class="p-4 min-h-screen">
      ...
      <div class="">
        <!-- Static Tabs -->
        <ul
          class="flex flex-wrap -mb-px text-lg font-bold text-center text-gray-500 dark:text-gray-400"
        >
          <!-- 'Item-in Tab -->
          <li class="me-2">
            <a
              href="#"
              v-if="
                hasPermission('Employee_Tab_Employee') &&
                hasPermission('Navigation_Employee') &&
                hasPermission('Navigation_Settings')
              "
              @click.prevent="activateTab('Employee')"
              :class="{
                'inline-flex text-blue-500 border-b-2 p-4 border-blue-600 bg-blue-100 rounded-t-lg active dark:text-blue-500 dark:border-blue-500':
                  activeTab === 'Employee',
          ...
          <li class="me-2">
            <a
              href="#"
              v-if="
                hasPermission('Employee_Tab_Position') &&
                hasPermission('Navigation_Employee') &&
                hasPermission('Navigation_Settings')
              "
