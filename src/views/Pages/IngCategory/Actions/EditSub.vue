        ...
        <div class="grid grid-cols-1 gap-6">
          <div class="mb-4">
            ...
            <input
              ...
              id="ProductName"
              required
              v-model="categoryForm.sub_category_name"
...
const fillForm = () => {
  ...
  categoryForm.value.ingredient_sub_category_id = data.id;
  categoryForm.value.sub_category_name = data.name;
  categoryForm.value.ingredient_sub_category_abbre = data.abbre;
};
const resetForm = () => {
...
const editCategory = async () => {
  try {
    ...
    const response = await axios.post(
      `${VUE_APP_API_URL}ingredient-sub-categories/edit`,
      formData,
      BearToken(token)
    );
