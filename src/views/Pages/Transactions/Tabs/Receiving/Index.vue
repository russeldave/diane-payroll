    ...
    >
      ...
      <li class="me-2 mb-2 md:mb-0">
        <a
          ...
          :class="{
            'inline-flex text-red-500 border-b-2 p-4 border-green-600 rounded-t-lg active dark:text-green-500 dark:border-green-500':
              activeTab === 'PRP',
        ...
        >
          ...
          <span
            ...
            ><small>List (For Purchase)</small></span
          >
        </a>
      </li>
      ...
      <li class="me-2 mb-2 md:mb-0">
        <a
          ...
          :class="{
            'inline-flex text-green-500 border-b-2 p-4 border-green-600 rounded-t-lg active dark:text-green-500 dark:border-green-500':
              activeTab === 'IFP',
            'inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group':
              activeTab !== 'IFP',
          }"
      ...
      <li class="me-2 mb-2 md:mb-0">
        ...
        >
          <i class="fas fa-file-invoice me-2"></i>
          <span class="text-xs sm:text-sm md:text-md xl:text-md hidden xl:inline"
            >PR List (Completed)</span
          >
          <span
            class="text-xs sm:text-sm md:text-md xl:text-md inline xl:hidden text-nowrap"
            ><small>List (Completed)</small></span
          >
        </a>
      </li>
      ...
      <li class="me-2 mb-2 md:mb-0">
        ...
        >
          <i class="fas fa-boxes me-2"></i>
          <span class="text-xs sm:text-sm md:text-md xl:text-md hidden xl:inline"
            >PR Items (Completed)</span
          >
          <span
            class="text-xs sm:text-sm md:text-md xl:text-md inline xl:hidden text-nowrap"
            ><small>Items (Completed)</small></span
          >
        </a>
      </li>
    </ul>
