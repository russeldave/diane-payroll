            ...
            >
              <div class="flex flex-col h-full ">
                <div class="flex items-end space-x-1 justify-center">
                  <p class="text-lg font-bold">{{ Number(mrf.releasedQuantity).toLocaleString() }}</p> 
                  {{ mrf.unitAbbre }}
                </div>
                <span class="underline">{{ mrf.releaseFromWarehouseName }}</span>
...
// import ModalMRF from "@views/Component/Ingredients/Actions/ModalMRF.vue";
import Swal from "sweetalert2";
import axios from "axios";
import Modal from "@/views/Component/Modal.vue";
import Paginator from "@/views/Component/Pagination.vue";
import BreadCrumbs from "@/views/Component/BreadCrumbs.vue";
import DownloadExcel from "../MRFItemsForReleasing/Actions/DownloadExcel.vue";
...
// controls
import PurchaseRequest from "../MRFItemsPending/Actions/PurchaseRequest.vue";
import Completed from "../MRFSlipForReleasing/Actions/Completed.vue";
import ReleaseItemToBin from "../MRFSlipForReleasing/Actions/ReleaseItemToBin.vue";
...
const listMRFs = async () => {
  try {
    ...
    const response = await axios.post(
      `${VUE_APP_API_URL}mrfs/list-mrf-items-releasings`,
      formData,
      BearToken(token)
    );
