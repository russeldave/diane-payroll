      ...
      <table class="min-w-full divide-y divide-gray-200 text-nowrap">
        ...
        <tbody class="bg-white divide-y divide-gray-200 text-xs md:text-sm">
          ...
          >
            ...
            <td class="px-2 py-2 border text-wrap">{{ mrf.requestedByEmployeeName }}</td>
            <!-- <td class="px-2 py-2 border">
              ...
              <!-- <td class="px-3 py-3 border bg-white/70 backdrop-blur-sm">
                <div class="flex flex-col items-center space-y-2 text-center">
                  ...
                  <span
                    class="inline-flex items-center gap-1 bg-blue-800 text-white text-xs font-medium px-3 py-1.5 
                          rounded-full shadow-sm hover:bg-blue-700 transition-all duration-200"
                  >
                    <span class="text-sm">FOR PR</span>
                  </span>
                  <div
                    v-if="mrf.isApproved == 1"
                  ...
                  <div
                    v-else
                    class="flex justify-center items-center rounded-md bg-yellow-500 text-white font-semibold text-sm px-4 py-1.5 animate-pulse shadow-sm"
                  >
            ...
            <td class="px-2 py-2 border text-center text-wrap">{{ mrf.remarks }}</td>
           <td class="px-2 py-2 border text-center text-wrap">
            {{ mrf.items}}
          </td>
            <td class="px-2 py-3 border">
              <div class="flex justify-center">
                ...
                />
                <!-- <Return v-if="hasPermission('MRF_Slip_Return_Item_Button')"  :key="mrf.id" :data="mrf" :warehouse_id="props.warehouse_id" @transaction_id="handleTransaction()"/> -->
                <!-- <EditMRF v-if="hasPermission('MRF_Slip_Edit_Button')"  :key="mrf.id" :data="mrf" :warehouse_id="props.warehouse_id" @transaction_id="handleTransaction()"/> -->
                <MRFSlip
...
import EditMRF from "@/views/Pages/Transactions/Tabs/Approval/MRFSlipForReleasing/Actions/EditMRF.vue";
