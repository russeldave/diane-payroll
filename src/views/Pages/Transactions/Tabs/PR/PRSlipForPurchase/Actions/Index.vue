      ...
      <table class="min-w-full divide-y divide-gray-200">
        ...
        <thead class="text-white shadow text-nowrap" :class="DEFAULT_BG">
          <tr class="border-b-2 border-solid">
            ...
            <th
              scope="col"
              class="px-2 py-3 border text-right text-xs md:text-sm font-medium tracking-wider"
            >
              PR'ed
            </th>
            <th
        ...
        <tbody class="bg-white divide-y divide-gray-200 text-xs md:text-sm md:text-md">
          ...
          >
            ...
            <td class="px-2 py-3 border text-right bg-red-500 text-white">
            ...
            <td class="px-2 py-3 border text-right bg-blue-500 text-white">
              <p>{{ pr.receivedQuantity ?? 0 }} {{ pr.unitAbbre }}</p>
            </td>
            <td class="px-2 py-3 border text-right">{{ pr.price ?? '-' }}</td>
...
import EditPRItem from "../PRSlipForPurchase/Actions/RejectPRItem.vue";
