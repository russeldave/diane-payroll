            ...
            >
              ...
              <div class="mb-2">
                ...
                <div class="flex">
                  <ItemTitle
                    :item_id="mrf.itemId"
                    :item_name="mrf.ingredientIdNumber + ' - ' + mrf.itemName"
                  />
                </div>
              </div>
              ...
              <div class="mb-2">
                ...
                >
                <div class="flex">
                 {{ formatNumberWithCommas (mrf.quantity) ?? 0 }} {{ mrf.unitAbbre }}
                </div>
              </div>
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200 text-sm">
              ...
              >
                ...
                <td
                  class="px-2 py-3 border text-white text-center text-nowrap hover:bg-green-200 bg-red-500 font-bold"
                >
                 {{ formatNumberWithCommas (mrf.quantity) ?? 0 }} {{ mrf.unitAbbre }}
                </td>
                <!-- <td
                ...
                <td class="p-0 border text-center hover:bg-green-200 text-white">
                  <div class="flex justify-center">
                    <ProofImageViewer
                      v-if="mrf.id"
                      :mrf_id="mrf.id"
                ...
                <td class="px-2 py-3 text-center border">{{ mrf.remarks }}</td>
