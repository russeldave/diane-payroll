...
const updateWarehouseStocks = async () => {
  try {
      ...
      const response = await axios.post(VUE_APP_API_URL+'warehouse-has-items/get-item-in-warehouses',{warehouse_id: search.value.warehouse_id,item_id: assignForm.value.item_id }, BearToken(token));
