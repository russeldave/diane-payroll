    ...
    <ul class="flex flex-nowrap xl:flex-wrap -mb-px text-sm md:text-lg font-bold text-center text-gray-500 dark:text-gray-400">
      ...
      <li class="me-2 mb-2 md:mb-0">
        ...
        >
          ...
          <span class="text-xs sm:text-sm md:text-md xl:text-md hidden xl:inline">MRF Items (For Approval)</span>
          <span class="text-xs sm:text-sm md:text-md xl:text-md inline xl:hidden text-nowrap"><small>For Approval</small></span>
        </a>
      </li>
    </ul>
  </div>
...
import MRFForReleasingTab from "../Approval/MRFSlipForReleasing/Index.vue";
import ForReleasingItemsTab from "../Approval/MRFItemsForReleasing/Index.vue";
