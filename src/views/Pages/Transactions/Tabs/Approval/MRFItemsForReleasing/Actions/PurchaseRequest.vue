          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <thead class="text-white shadow" :class="DEFAULT_BG">
              <tr class="border border-solid text-nowrap">
                ...
                <th
                  scope="col"
                  class="px-2 py-3 text-right text-sm ont-medium uppercase tracking-wider border border-solid bg-blue-500"
                >
                  Requested
                </th>
                <th
                  scope="col"
                  class="px-2 py-3 text-right text-sm font-medium uppercase tracking-wider border border-solid bg-red-500"
                >
                  Adjusted
                </th>
                <th
