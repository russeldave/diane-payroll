<template>
  <button
    ...
    type="button"
    :class="[
      'bg-lime-500 text-white hover:opacity-70 hover:border-4 hover:border-lime-700 focus:bg-lime-300 font-bold text-sm md:text-md py-2 px-4 rounded-lg   hover:scale-110',
      className,
    ]"
  >
