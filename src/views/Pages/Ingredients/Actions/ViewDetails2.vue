  ...
  <div>
    <div class="flex flex-row flex-wrap">
      <p
        ...
        class="bg-blue-500 rounded-md font-bold text-white px-2 py-2  border hover:text-blue-100 hover:bg-blue-800 cursor-pointer flex items-center gap-2"
        >
       Ingredient
      </p>
    </div>
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-2">
          ...
          <div class="w-full rounded-md">
            ...
            <div 
              ...
              class="grid grid-cols-5 border rounded-md">
              <span class="col-span-3 border p-2">{{item.warehouseName}}</span>
              <span class="col-span-2 border p-2 font-extrabold text-lg"
              :class="item.floatStocks < 1 ? ' bg-red-200':' bg-green-200'">
                {{ item.floatStocks }}
            ...
            <div class="max-h-[400px] overflow-y-auto">
              <IngImageViewer
                :key="props.id"
                :ingredient_id_number="details.ingredientIdNumber"
            ...
            <div class="bg-white rounded-lg shadow-sm">
              <div class="p-4 space-y-4">
                ...
                <div>
                  ...
                  <div class="p-2 rounded border bg-gray-200">
                    <span >{{ details.ingredientIdNumber }} -&nbsp;</span>
                    <span class="font-bold">
                      {{ details.name }}
                    </span>
                    <span class="text-red-500 italic">[{{ details.unitAbbre }}]</span>
                  </div>
                </div>
...
const fetchDetails = async () => {
  ...
  try {
    const formData = FormDx({ ingredient_id: props.ingredient_id_number });
