        ...
        <div class="grid grid-cols-1 md:grid-cols-4">
            ...
            <div class="mb-4">
              ...
              <div class="flex mt-1">
                <input
                  ...
                  :class="
                    hasPermission('Override_Buffet_Name')
                      ? 'bg-white rounded-l'
                      : ' bg-gray-200 rounded'
                  "
                ...
                />
                <OverrideBuffetName
                  v-if="hasPermission('Override_Buffet_Name')"
                  :key="buffetForm.name"
                  :data="buffetForm"
                />
              </div>
          ...
          <div class="block md:col-span-3 p-4">
            ...
            >
              ...
              <div>
                <DeleteAllBuffetMenus
                  :key="buffetForm.buffet_id"
                  :buffet_id="buffetForm.buffet_id"
...
import DeleteAllBuffetMenus from "./DeleteAllBuffetMenus.vue";
