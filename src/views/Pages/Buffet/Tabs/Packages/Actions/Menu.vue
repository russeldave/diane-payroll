      ...
      <div class="flex justify-between items-center px-0 py-2" v-if="props.data">
        ...
        <div class="flex flex-row">
          ...
          >
            ...
            <span>download buffet menus</span>
          </a>
            ...
            <tr class="text-nowrap">
              ...
              >
                <div class="flex flex-col items-center text-rose-300">
                  ...
                  <span class="text-sm text-yellow-500 mt-1"
                    >({{ moneyFormatter(data.grandTotalScrapLoss ?? 0) }})
                  </span>
                </div>
              </th>
...
import AddLeftOver from "@/views/Pages/Buffet/Tabs/List/Actions/AddLeftOver.vue";
import AddServe from "@/views/Pages/Buffet/Tabs/List/Actions/AddServe.vue";
import AddScrap from "@/views/Pages/Buffet/Tabs/List/Actions/AddScrap.vue";
import Prepare from "@/views/Pages/Buffet/Tabs/List/Actions/Prepare.vue";
import SnapShotCostPrice from "@/views/Pages/Buffet/Tabs/List/Actions/SnapShotCostPrice.vue";
...
const downloadReport = async () => {
  ...
  try {
    const formData = FormDx({buffet_id : props.data.id});
    const response = await axios.post(
      `${import.meta.env.VITE_API_URL}buffet-download-excel/served-left-over`,
      formData,
      {
        ...BearToken(token),
        responseType: "blob",
