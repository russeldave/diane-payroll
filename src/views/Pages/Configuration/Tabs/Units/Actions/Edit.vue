<template>
  ...
  >
    ...
    <div class="grid grid-cols-1 gap-6 p-6">
      ...
      <form class="mt-4" @submit.prevent="editUnit()" autocomplete="off">
        <div class="grid grid-cols-1 gap-6">
          <div class="mb-4">
            ...
            <input
              type="text"
              id="ProductName"
              v-model="unitForm.item_brand_name"
...
const fillForm = () => {
  ...
  unitForm.value.brand_id = data.id;
  unitForm.value.item_brand_name = data.name;
  unitForm.value.remarks = data.remarks;
};

const resetForm = () => {
  unitForm.value.brand_id = 0;
  unitForm.value.item_brand_name = "";
